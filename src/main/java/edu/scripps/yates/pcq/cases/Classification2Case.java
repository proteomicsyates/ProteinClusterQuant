...
public enum Classification2Case {
	...
	CASE3(3, "Unique peptide is significantly different, or difference between the two unique peptides is larger than threshold",
			true), //
	CASE4(4, "Both unique peptides are significantly different and shared peptide is significantly different in between",
			true), //
	CASE5(5, "There is not a significant differences. Difference between unique peptides is less than threshold",
			false), //
	CASE6(6, "Not classified", false);
